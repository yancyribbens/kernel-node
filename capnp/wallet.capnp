...
interface Wallet {
    ...
    sendToAddress @5 (address :Text, amountSat :UInt64, feeRateSatPerVb :Float64, consolidateFeeRateSatPerVb :Float64 = 10, discardFeeRateSatPerVb :Float64 = 10) -> (ok :Bool, message :Text);
}
